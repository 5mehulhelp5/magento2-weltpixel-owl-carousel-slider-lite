...
$ composer config repositories.welpixel-magento2-weltpixel-owl-carousel-slider-lite git https://github.com/Weltpixel/magento2-weltpixel-owl-carousel-slider-lite.git
